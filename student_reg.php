        ...
        <div class="step-box active bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8" id="step1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2.5 px-4" id="aadhaar" maxlength="12" placeholder="XXXX-XXXX-XXXX" />
                </div>
                ...
                <div>
                    ...
                    <input type="date" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2.5 px-4" id="dob" />
                </div>

                <!-- Place of Birth -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-1">Place of Birth</label>
                    <input type="text" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2.5 px-4" id="birth_place" placeholder="Enter place of birth" />
                </div>
        ...
        <div class="step-box bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8" id="step3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2.5 px-4" id="student_phone" maxlength="10" placeholder="Enter student phone" />
                </div>

                <!-- Parent Phone -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-1">Parent Phone</label>
                    <input type="text" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 bg-white py-2.5 px-4" id="parent_phone" maxlength="10" placeholder="Enter parent phone" />
                </div>
