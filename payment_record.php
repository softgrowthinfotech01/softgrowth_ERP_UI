    ...
    <div class="bg-gray-800 rounded-xl p-5">
        ...
        <div class="flex flex-col md:flex-row md:justify-between gap-3 mb-4">
            ...
            <div class="flex gap-2 flex-wrap">
                ...
                <button class="btn bg-slate-700 hover:bg-slate-600">Copy</button>
                <button class="btn bg-blue-600 hover:bg-blue-500">CSV</button>
                <button class="btn bg-green-600 hover:bg-green-500">Excel</button>
                <button class="btn bg-red-600 hover:bg-red-500">PDF</button>
                <button class="btn bg-purple-600 hover:bg-purple-500">Print</button>
